                ...
                >
                  ...
                  <div className="flex justify-center gap-3 sm:gap-4">
                    <Link href={project.github} target="_blank" aria-label={`View ${project.title} on GitHub`}>
                      <button className="btn btn-outline group text-sm sm:text-base px-4 sm:px-6 py-1.5 sm:py-2">
                    ...
                    <Link href={project.live} target="_blank" aria-label={`Live demo of ${project.title}`}>
                      <button className="btn btn-primary group text-sm sm:text-base px-4 sm:px-6 py-1.5 sm:py-2">
                        <span className="flex items-center gap-1.5 sm:gap-2">
